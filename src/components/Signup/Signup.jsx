...
const [callingRespose, setcallingRespose] = useState(false)
  let validation =Yup.object().shape({
    ...
    rePassword:Yup.string().oneOf([Yup.ref('password')],"Not match password").required("repassword is required"),
    phone:Yup.string().matches(/^01[0125][0-9]{8}$/,"phone must be egyptian number ")
  }) 
...
let formik=useFormik({
  ...
  <div>
    ...
    <h1 className='text-3xl w-3/4 mx-auto  '> Sign up </h1>
<form className="w-3/4 mx-auto"   onSubmit={formik.handleSubmit}>
  ...
  <div className="relative z-0 w-full mb-5 group mt-6">
    ...
    <label htmlFor="name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-main-border-main-color peer-focus:dark:text-maborder-main-color peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name</label>
  ...
  <div className="relative z-0 w-full mb-5 group">
    ...
    <label htmlFor="floating_repeat_password" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-main-border-main-color peer-focus:dark:text-maborder-main-color peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Confirm password</label>
  ...
  <div className="relative z-0 w-full mb-5 group">
    ...
    <label htmlFor="phone" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-main-border-main-color peer-focus:dark:text-maborder-main-color peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone</label>
