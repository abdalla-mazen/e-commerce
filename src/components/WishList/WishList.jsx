...
const [list, setlist] = useState([])
 ...
 async function deleteToWish(id) {
  ...
  { list.map((listt)=><div key={listt.id} href="#" className="flex  flex-col items-center justify-between bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row  my-5 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
