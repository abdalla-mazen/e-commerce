...
let validationSchema =Yup.object().shape({
    ...
    newPassword:Yup.string().matches(/^[A-Z][a-z1-9]{5,10}$/,"Password must start with an uppercase letter and contain 5-10 lowercase letters or numbers.").required("Password is required"),
  }) 


  let navigate = useNavigate();
  async function handlePassword(formValues ){
...
<div>
  ...
  <h1 className='text-3xl w-3/4 mx-auto py-5 '> Reset Password </h1>
